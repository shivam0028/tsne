# -*- coding: utf-8 -*-
"""
Created on Tue Aug  6 14:14:52 2019
...
for sigma in [0.5, 1.0, 1.5, 2.0, 3.0, 5.0]:
    ...
    plt.savefig('symmetric_sne_'+dataset+'_sigma_'+str(sigma)+'.eps',
                format='eps', dpi=1000)
    plt.close()
    np.savetxt('symmetric_sne_'+dataset+'_sigma_cost_'+str(sigma)+'.txt', C)
...
for perplexity in [5.0, 10.0, 15.0, 20.0, 30.0, 50.0, 100.0]:
    ...
    plt.savefig('symmetric_sne_'+dataset+'_perplexity_'+str(perplexity)+'.eps',
                format='eps', dpi=1000)
    plt.close()
    np.savetxt('symmetric_sne_'+dataset+'_perplexity_cost_'+str(perplexity)+'.txt', C)
